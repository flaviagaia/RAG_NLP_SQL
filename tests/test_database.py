...
from src.sample_database import create_sample_database, ensure_sample_database
...
class SampleDatabaseTest(unittest.TestCase):
    def test_database_creation_and_seed(self):
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            create_sample_database(db_path, reset=True)
    ...
    def test_ensure_database_is_idempotent(self):
        with tempfile.TemporaryDirectory() as temp_dir:
            db_path = Path(temp_dir) / "sample.db"
